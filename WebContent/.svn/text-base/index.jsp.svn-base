...
<body>
	<%
		/**Wap网关Via头信息中特有的描述信息*/
		String mobileGateWayHeaders[] = new String[] { "ZXWAP",//中兴提供的wap网关的via信息，例如：Via=ZXWAP GateWayZTE Technologies，
		...
		String[] mobileUserAgents = new String[] { "Nokia",//诺基亚，有山寨机也写这个的，总还算是手机，Mozilla/5.0 (Nokia5800 XpressMusic)UC AppleWebkit(like Gecko) Safari/530
		...
		if (pcFlag) {
			dispatcher = request.getRequestDispatcher("/tmweb/query.jsp");
		}
		if (mobileFlag) {
			dispatcher = request.getRequestDispatcher("/tm/index.jsp");
		}

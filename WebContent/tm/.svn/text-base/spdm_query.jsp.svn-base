...
<body scroll="no" style="overflow-x: hidden" topmargin="0"
	...
	<form id="frm" name="frm" method="post" action="/spdmgf/gospdmgflist.html">
		...
		<div style="margin-top: 48px;">
			...
			<div align="center">
				...
				<input id="query" type="button" class="tsubmit" value="规范查询">
				<input id="query2" type="button" class="tsubmit2" value="非规范查询">
			</div>
		</div>
	</form>
	<script Language="javaScript" src="/tm/js/spdm_query.js"></script>
</body>
</html>
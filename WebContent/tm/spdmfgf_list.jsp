...
<body scroll="no" style="overflow-x: hidden" >
	...
	<div style="margin-top: 48px;">
		<form name="frm" method="post" action="/ftmid/mwebquery.html">
			<input type="hidden" name="ftmid" id="ftmid">
			<input type="hidden" name="tmlb" id="tmlb">
		</form>
		<table class="t_table" id="t_table">
			<thead class="t_table_tr2">
				...
				<td class="t_table_td_right"><nobr>注册号</nobr></td>
	...
	<script Language="javaScript" src="/tm/js/spdmfgf_list.js"></script>
</body>
</html>